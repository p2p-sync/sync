...
public class FileDemandRequest extends ARequest {
     ...
     */
    public FileDemandRequest(UUID exchangeId, StatusCode statusCode, ClientDevice clientDevice, String relativeFilePath, List<ClientLocation> receiverAddresses, long chunkCounter) {
